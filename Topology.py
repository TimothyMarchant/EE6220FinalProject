...
def CameraTopology():
        ...
        net.addLink(EmergencyCenter,s3,bw=100) #High bandwidth

        net.addLink(s1,s3,bw=100) #cannot make switch from Box 1 to S3 without causing problems.
        net.addLink(s2,s3,bw=100) #cannot make switch from Box 2 to S3 without causing problems.

        net.addLink(Datacenter,s3,bw=100) #Data storage platform.
